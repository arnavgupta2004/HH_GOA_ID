...
function AuroraBackground() {
  return (
    ...
    >
      <div className="absolute -top-40 -left-32 h-[36rem] w-[36rem] rounded-full bg-teal-500/20 blur-[120px]" />
      <div className="absolute top-1/4 -right-40 h-[32rem] w-[32rem] rounded-full bg-fuchsia-500/15 blur-[130px]" />
      <div className="absolute bottom-[-12rem] left-1/4 h-[30rem] w-[30rem] rounded-full bg-indigo-500/15 blur-[140px]" />
      <div
    ...
    <header className="sticky top-0 z-40 border-b border-white/[0.06] bg-black/40 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-6">
        <div className="flex items-center gap-2">
          ...
          <img src="/hh-logo.svg" alt="Hacker House Goa 2026" className="h-4 w-auto" />
        </div>
